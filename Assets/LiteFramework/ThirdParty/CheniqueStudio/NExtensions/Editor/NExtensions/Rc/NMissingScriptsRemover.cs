...
public static class NFindMissingScriptsRecursively
{
    ...
    private static void FindAndRemoveMissingInSelected()
    {
        ...
        var selected = Selection.gameObjects.SelectMany(go => go.GetComponentsInChildren<Transform>(true))
    ...
    private static void RecursivePrefabSource(GameObject instance, HashSet<Object> prefabs,
        ref int removedComponentsCount, ref int removedGameObjectsCount)
    {
