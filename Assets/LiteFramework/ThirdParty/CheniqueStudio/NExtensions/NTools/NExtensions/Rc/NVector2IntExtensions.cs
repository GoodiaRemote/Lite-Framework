...
{
    public static class NVector2IntExtensions
    {
        /// <summary>
        ...
        public static (Vector2 point, float distance) GetClosestPointOnRay(this Vector2Int point, Vector2 origin,
            Vector2 direction)
        {
            return NVector2Extensions.GetClosestPointOnRay(point, origin, direction);
        }
        ...
        public static (Vector2 point, float distance) GetClosestPointOnSegment(this Vector2Int point, Vector2 start,
            Vector2 end)
        {
            return NVector2Extensions.GetClosestPointOnSegment(point, start, end);
        }
    }
}