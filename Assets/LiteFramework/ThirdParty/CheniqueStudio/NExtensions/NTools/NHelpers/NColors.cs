...
namespace CheniqueStudio.NExtensions.NTools.NHelpers
{
	...
	public static class NColors
    {
        ...
        /// <returns></returns>
        public static Color NRandomColor(this Color color, Color min, Color max)
        {
            var c = new Color
            {
        ...
        public static Color NColorize(this Color originalColor, Color targetColor, ColoringMode coloringMode,
        ...
        public static Color HtmlToColor(string hexColor)
        {
            ColorUtility.TryParseHtmlString(hexColor, out var tempColor);
            return tempColor;
        }
