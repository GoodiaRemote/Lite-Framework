...
namespace CheniqueStudio.NExtensions.NTools.NHelpers
{
	...
	public static class NMovement
    {
	    ...
	    public static IEnumerator MoveFromTo(GameObject movingObject, Vector3 pointA, Vector3 pointB, float duration,
        ...
        public static IEnumerator AnimateScale(Transform targetTransform, Vector3 vector, float duration,
            AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ, float multiplier = 1f)
        {
            if (targetTransform == null) yield break;

            if (curveX == null || curveY == null || curveZ == null) yield break;
