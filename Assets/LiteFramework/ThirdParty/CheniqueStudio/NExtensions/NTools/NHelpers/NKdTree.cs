...
{
    public class NKdTree<T> : IEnumerable<T>, IEnumerable where T : Component
    {
        ...
        public NKdTree(bool just2D = false)
        {
            _just2D = just2D;
        }
        ...
        public NKdTree<T> FindAll(Predicate<T> match)
        {
            var list = new NKdTree<T>(_just2D);
