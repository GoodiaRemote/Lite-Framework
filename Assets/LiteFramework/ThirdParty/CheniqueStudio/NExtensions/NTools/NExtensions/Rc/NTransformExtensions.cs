...
namespace NExtensions.NTools.NExtensions.Rc
{
    public static class NTransformExtensions
    {
        /// <summary>
        ...
        {
            var maxSiblingIndex = (transform.parent != null
        ...
        /// <summary>
        ///     Returns the previous transform next to the current object. If there is no previous one, then the current transform
        ///     is returned.
        /// </summary>
        /// <param name="transform">Target transform.</param>
        ...
        /// <summary>
        ///     Returns the next transform next to the current object. If there is no next one, then the current transform is
        ///     returned.
        /// </summary>
        /// <param name="transform">Target transform.</param>
