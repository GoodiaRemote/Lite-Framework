...
{
    public static class NCanvasScalerExtensions
    {
        /// <summary>
        ///     Get scale factor which canvas scaler calculated when work in
        ///     <see cref="CanvasScaler.ScaleMode.ScaleWithScreenSize" /> mode.
        /// </summary>
