...
namespace CheniqueStudio.NExtensions.NTools.NHelpers
{
   ...
   /// <summary>
    ...
    /// </summary>
    public static class NRectTransformExtensions
    {
        /// <summary>
        ...
        public static void NSetLeft(this RectTransform rt, float left)
        {
        ...
        public static void NSetRight(this RectTransform rt, float right)
        {
        ...
        public static void NSetTop(this RectTransform rt, float top)
        {
        ...
        public static void NSetBottom(this RectTransform rt, float bottom)
        {
