...
{
    public static class NVector3IntExtensions
    {
        /// <summary>
        ...
        public static (Vector3 point, float distance) GetClosestPointOnRay(this Vector3Int point, Vector3 origin,
            Vector3 direction)
        {
            return NVector3Extensions.GetClosestPointOnRay(point, origin, direction);
        }
        ...
        public static (Vector3 point, float distance) GetClosestPointOnSegment(this Vector3 point, Vector3 start,
            Vector3 end)
        {
            return NVector3Extensions.GetClosestPointOnSegment(point, start, end);
        }
    }
}